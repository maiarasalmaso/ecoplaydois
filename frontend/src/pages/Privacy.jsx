  ...
  const purposes = [
    {
      ...
      icon: <Eye className="w-6 h-6 text-eco-green" />
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 space-y-20">
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-6">Nosso Compromisso</h2>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-white mb-8 text-center">Coleta de Dados</h2>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-white mb-8 text-center">Como Usamos Seus Dados</h2>
          <p className="text-slate-300 text-center mb-12 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {purposes.map((purpose, index) => (
              ...
              >
                ...
                <p className="text-slate-300 leading-relaxed">{purpose.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-8 text-center">Seus Direitos (LGPD)</h2>
          <p className="text-slate-300 text-center mb-12 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {rights.map((right, index) => (
              ...
              >
                ...
                <p className="text-slate-300 text-sm leading-relaxed mb-3">{right.description}</p>
                <div className="flex items-center gap-2 text-xs">
                  <div className="w-2 h-2 bg-eco-green rounded-full"></div>
                  <span className="text-eco-green font-medium">{right.article}</span>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="mt-8 p-6 bg-blue-500/10 rounded-xl border border-blue-500/30">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Como Exercer Seus Direitos</h3>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-white mb-8 text-center">Cookies e Tecnologias Similares</h2>
          
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
              <h3 className="text-xl font-bold text-white mb-4">Cookies Essenciais</h3>
            ...
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
              <h3 className="text-xl font-bold text-white mb-4">Cookies de Performance</h3>
              <p className="text-slate-300 mb-4">
            ...
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
              <h3 className="text-xl font-bold text-white mb-4">Cookies de Funcionalidade</h3>
              <p className="text-slate-300 mb-4">
          ...
          <div className="bg-yellow-500/10 p-6 rounded-xl border border-yellow-500/30">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Controle de Cookies</h3>
                <p className="text-slate-300 leading-relaxed">
        ...
        <motion.section
          ...
          className="bg-slate-800/30 p-8 rounded-3xl border border-slate-700"
        >
          <h2 className="text-4xl font-bold text-white mb-8 text-center">Medidas de Segurança</h2>
          <p className="text-slate-300 text-center mb-12 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {securityMeasures.map((measure, index) => (
              <motion.div
                ...
                transition={{ duration: 0.4, delay: index * 0.05 }}
                viewport={{ once: true }}
                className="flex items-center gap-3 p-4 bg-slate-700/50 rounded-xl"
              >
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-6 text-center">Alterações nesta Política</h2>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-600 mb-6">
              <h3 className="text-xl font-bold text-white mb-4">Como Notificamos Alterações</h3>
        ...
        <motion.section
          ...
          className="text-center"
        >
          <h2 className="text-3xl font-bold text-white mb-6">Dúvidas sobre Privacidade?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="px-8 py-4 bg-blue-500 text-white rounded-full font-medium hover:bg-blue-600 transition-colors flex items-center gap-3"
            >
